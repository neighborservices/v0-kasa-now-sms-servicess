        ...
        <section className="bg-white py-20 md:py-32">
          <div className="container mx-auto max-w-7xl px-4">
            <h2 className="mb-6 text-4xl font-bold text-gray-900 md:text-5xl lg:text-6xl">
              AI that delivers results, not complexity
            </h2>
            <p className="mb-16 max-w-3xl text-xl text-gray-600">
              We put AI behind your most critical SMS tasks. Turn contact lists into insights in seconds – move faster,
              reduce manual work, and make better decisions at scale.
            </p>

            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              <Card className="border-2">
                <CardContent className="p-8">
                  <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-[#FF8800]/10">
                    <Bot className="h-6 w-6 text-[#FF8800]" />
                  </div>
                  <h3 className="mb-3 text-xl font-bold">AI Message Optimization</h3>
                  <p className="mb-4 text-gray-600">
                    Let AI suggest better copy, optimize send times, and predict campaign performance before you hit
                    send.
                  </p>
                  <Link
                    href="#"
              ...
              <Card className="border-2">
                <CardContent className="p-8">
                  <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-[#FF8800]/10">
                    <Target className="h-6 w-6 text-[#FF8800]" />
                  </div>
                  <h3 className="mb-3 text-xl font-bold">Smart Audience Segmentation</h3>
                  <p className="mb-4 text-gray-600">
                    AI-powered contact segmentation finds hidden patterns and suggests optimal targeting strategies.
                  </p>
                  <Link
                    href="#"
                    className="inline-flex items-center text-sm font-semibold text-[#5B6EF5] hover:underline"
              ...
              <Card className="border-2">
                <CardContent className="p-8">
                  ...
                  <h3 className="mb-3 text-xl font-bold">Multi-Language Support</h3>
                  <p className="mb-4 text-gray-600">
                    Reach global markets with AI-powered translation and localization for 100+ languages.
                  </p>
            ...
            <div className="mt-12 text-center">
              <Link
                ...
                className="inline-flex items-center text-base font-semibold text-[#5B6EF5] hover:underline"
              >
                Explore All AI Features → <ArrowRight className="ml-2 h-5 w-5" />
              </Link>
            </div>
          </div>
        </section>
